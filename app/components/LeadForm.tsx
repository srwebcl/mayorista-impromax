    ...
    return (
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[2rem] shadow-[0_8px_40px_rgb(0,0,0,0.2)] p-8 md:p-10 relative overflow-hidden">
            ...
            <form id="leadForm" className="space-y-5 relative z-10" onSubmit={handleSubmit}>
                <div>
                    <input name="name" type="text" required className="w-full px-5 py-4 rounded-xl bg-white/5 border border-white/10 focus:bg-white/10 focus:border-[#ea6721] text-white placeholder-gray-400 outline-none transition-all duration-300 focus:shadow-[0_0_15px_rgba(234,103,33,0.2)]" placeholder="Nombre Completo" />
                </div>
                <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <input name="email" type="email" required className="w-full px-5 py-4 rounded-xl bg-white/5 border border-white/10 focus:bg-white/10 focus:border-[#ea6721] text-white placeholder-gray-400 outline-none transition-all duration-300 focus:shadow-[0_0_15px_rgba(234,103,33,0.2)]" placeholder="Email Comercial" />
                    </div>
                </div>
                <div>
                    <div className="relative">
                        <select name="interest" required defaultValue="" className="w-full px-5 py-4 rounded-xl bg-white/5 border border-white/10 focus:bg-white/10 focus:border-[#ea6721] text-gray-300 outline-none transition-all duration-300 appearance-none focus:shadow-[0_0_15px_rgba(234,103,33,0.2)]">
